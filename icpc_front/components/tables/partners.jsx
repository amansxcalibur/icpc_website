...
export default function OutreachPartners(){
    return(
        <div className="text-blue-950 flex justify-center flex-col items-center relative overflow-hidden py-[5vw] pb-[6vw] min-h-[50vh]">
            <div className="min-w-[90vw] flex relative flex-col">
                ...
                <div className="flex w-full justify-center max-w-[100vw] overflow-hidden items-center py-[1vw]">
                    <div className="flex-1 flex max-w-[70vw] gap-x-[10vw] min-h-[15vw]">
                        <Link href="https://www.codechef.com/" className="flex-1 rounded-[1vw] border-blue-950 border-[.25vw] border-solid hover:bg-yellow-100 shadow-[5px_5px_0px_0px_rgba(23,_37,_84,_1)] transition flex justify-center items-center">
                            <Image src="https://cdn.codechef.com/images/cc-logo.svg" className="h-[6vw] w-auto" width={1} height={1} unoptimized />
                        </Link>
                        <Link href="https://www.geeksforgeeks.org/" className="flex-1 rounded-[1vw] border-blue-950 border-[.25vw] border-solid hover:bg-yellow-100 shadow-[5px_5px_0px_0px_rgba(23,_37,_84,_1)] flex justify-center items-center">
