            ...
            <div className="flex justify-center min-w-[80vw] mt-[2vw] flex-col">
                <div className="flex-1 min-h-[10vw] flex items-center mt-[5vw] max-md:flex-col">
                    <div className="flex-1 flex justify-center">
                        <Image src="/more_people_icpc.jpg" width={1} height={1} unoptimized className="min-h-[20vw] md:w-auto max-md:min-h-[60vw] max-md:min-w-[90vw] min-w-[30vw] bg-gray-500 rounded-[2vw]"></Image>
                    </div>
                ...
                <div className="flex-1 min-h-[10vw] flex items-center mt-[10vw] max-md:flex-col-reverse">
                    ...
                    <div className="flex-1 flex justify-center">
                        <Image src="/webinar.jpg" width={1} height={1} unoptimized className="min-h-[20vw] max-md:min-h-[60vw] max-md:min-w-[90vw] min-w-[30vw] bg-gray-500 rounded-[2vw] md:w-auto"></Image>
                    </div>
                </div>
                <div className="flex-1 min-h-[10vw] flex items-center mt-[10vw] max-md:flex-col">
                    <div className="flex-1 flex justify-center">
                        <Image src="/winner_icpc.jpg" width={1} height={1} unoptimized className="min-h-[20vw] md:w-auto min-w-[30vw] max-md:min-h-[60vw] max-md:min-w-[90vw] bg-gray-500 rounded-[2vw]"></Image>
                    </div>
                    <div className="flex-1 flex flex-col items-center">
