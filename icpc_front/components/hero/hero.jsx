export default function Hero(){
    return(
        ...
        <div className="min-h-[50vw] flex flex-col justify-center items-center w-full max-md:mt-[15vw] max-md:min-h-[90vw] ">
            <p className="text-[3.5vw] max-md:text-[6vw] tracking-tighter max-w-[50vw] max-md:max-w-[90vw] text-center text-[#4b82c4] font-semibold mb-[2vw]">Breaking Barriers in<br/> Competitive Programming</p>
            <p className="text-[1.4vw] max-md:text-[4vw] max-w-[50vw] max-md:max-w-[90vw] text-center text-black font-medium tracking-tighter mb-[2vw]">Representing Indias brightest minds,<br/>ICPC Amritapuri is a powerhouse in the world of competitive coding.</p>
